        ...
        >
          <div className="bg-gradient-to-br from-[#35363A] to-black border border-white/10 rounded-2xl p-8 text-center">
            ...
            <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
              <div>
                <p className="text-3xl font-semibold text-[#81D8D0] mb-1">14</p>
                <p className="text-sm text-white/60">Comunidades</p>
              </div>
              <div>
              ...
              <div>
                <p className="text-3xl font-semibold text-[#C8102E] mb-1">4</p>
              ...
              {filteredCommunities.map((community, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-white/3 border-2 rounded-2xl p-6 transition-all group ${
                    ...
                    whileHover={{
                      borderColor: `${community.config.color}60`,
                    }}
                  >
                    {/* Header */}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          {isActive ? (
                            ...
                            <span className="px-2 py-0.5 rounded text-xs font-semibold bg-white/10 text-white/50">
                              Em breve
                            </span>
                          )}
                    ...
                    <div className="flex items-center gap-4 text-sm text-white/50">
                      ...
                      <div className="flex items-center gap-1.5">
                        <Unlock className="h-4 w-4 text-[#81D8D0]" />
                        <span>Aberta</span>
                      </div>
                    </div>
                  </motion.div>
        ...
        >
          ...
          <div className="bg-[#C8102E]/10 border border-[#C8102E]/30 rounded-2xl p-6">
            ...
            <ul className="space-y-2 text-sm text-white/80 font-normal">
              ...
              <li className="flex items-start gap-2">
                <span className="text-[#C8102E] font-bold mt-0.5">•</span>
                <span>Não romantize caos, trauma ou autodestruição. Isso não é acolhimento.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#C8102E] font-bold mt-0.5">•</span>
                <span>Cada comunidade tem regras específicas. Leia antes de postar.</span>
              </li>
            </ul>
          </div>
        </motion.div>
